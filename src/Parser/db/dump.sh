...
sudo docker exec MYSQL_PARSER mysqldump --no-data -uPARSER -pPARSER PARSER  > GENERATED.SQL
sudo docker exec MYSQL_PARSER_ORIG mysqldump --no-data -uPARSER -pPARSER PARSER  > ORIG.SQL
